...
|---|---|---|
| P0 | Four-bank Ghidra function recovery | 117 stable reviewed functions are recovered; finish remaining bank 0/1 boundaries, resolve `$76A7`, review bank 3, and export call graphs/memory references. |

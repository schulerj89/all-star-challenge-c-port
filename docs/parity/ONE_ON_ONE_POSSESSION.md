...
recovery, steals, contest jumps, charging/blocking contact penalties, CPU
contact rerouting, and the ROM's explicit lack of recoil and a separate
goaltending/live-block branch are covered. The focused result must still not
be read as frame-perfect completion of the whole mode.

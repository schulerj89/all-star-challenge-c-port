#!/usr/bin/env python3
"""Validate and report scoped H-O-R-S-E gameplay coverage."""
...
MANIFEST = ROOT / "docs" / "parity" / "HORSE_COVERAGE.json"
...
def main() -> int:
    ...
    if args.as_json:
        ...
        print(f"H-O-R-S-E gameplay coverage: {verified}/{expected} ({percent:.2f}%)")

#!/usr/bin/env python3
"""Validate and report focused One-on-One shot-result coverage."""
...
MANIFEST = ROOT / "docs" / "parity" / "ONE_ON_ONE_SHOT_RESULT_COVERAGE.json"
...
def main() -> int:
    ...
    print(f"One-on-One shot-result coverage: {verified}/{expected} ({percent:.2f}%)")
